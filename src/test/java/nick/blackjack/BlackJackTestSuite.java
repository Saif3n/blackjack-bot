...
@RunWith(Suite.class)
@SuiteClasses({ BlackJackTestSuite.Task1Test.class, BlackJackTestSuite.Task2Test.class,
...
public class BlackJackTestSuite {
	...
	public abstract static class TaskTest {
		...
		void runCommands(BlackJack blackJack, String... commands) {
			...
			sb.append("exit");
			Main.scanner = new Scanner(sb.toString());
			blackJack.start();
	...
	public static class Task1Test extends TaskTest {
		...
		public void T1_01_not_always_hold_random() throws InterruptedException {
			...
			outer: for (int i = 0; i < 1000; i++) {
				for (int index : Arrays.asList(1, 2)) { // need to check list position 1 and 2
					if (blackJack.getPlayers().get(index).decideAction(hand).equals(Participant.Action.HIT)) {
						foundHit = true;
						break outer;
					}
				}
		...
		public void T1_04_low_risk_correctly_hold() {
			Main.scanner = new Scanner("LR");
			blackJack.initBots();
			sanityCheck();
			Hand hand = new Hand();
			hand.addCard(new Card(Card.Rank.KING, Card.Suit.DIAMONDS));
			hand.addCard(new Card(Card.Rank.FOUR, Card.Suit.SPADES));
			assertEquals(blackJack.getPlayers().get(1).decideAction(hand), Participant.Action.HIT);
			assertEquals(blackJack.getPlayers().get(2).decideAction(hand), Participant.Action.HIT);
			hand.addCard(new Card(Card.Rank.FOUR, Card.Suit.CLUBS));
			assertEquals(blackJack.getPlayers().get(1).decideAction(hand), Participant.Action.HOLD);
			assertEquals(blackJack.getPlayers().get(2).decideAction(hand), Participant.Action.HOLD);
		}
	...
	public static class Task2Test extends TaskTest {
		...
		public void T2_01_highest_bidder_should_hit_and_loose() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.CLUBS), // human
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack - not relevant
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack - not relevant
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.CLUBS) // dealer should hit and be
																						// busted
			);
		...
		public void T2_02_highest_bidder_should_hit_and_win() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.CLUBS), // human
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack - not relevant
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack - not relevant
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS) // dealer should hit and win
			);
			runCommands(blackJack, "LR", "100", "hold", " ", " ", " ", "no");
			assertContains("Round 1: Dealer's score is: 19");
			assertContains("Round 1: Dealer #1 HIT");
		...
		public void T2_03_highest_bidder_should_hold() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.SEVEN, Card.Suit.CLUBS), // human
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack - not relevant
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack - not relevant
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.FIVE, Card.Suit.CLUBS), new Card(Card.Rank.FIVE, Card.Suit.HEARTS)// dealer should hit and hold
			);
		...
		public void T2_04_highest_bidder_should_hold_same_score() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.SEVEN, Card.Suit.CLUBS), // human
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack - not relevant
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack - not relevant
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.FOUR, Card.Suit.CLUBS), new Card(Card.Rank.FIVE, Card.Suit.CLUBS) // dealer should hit and hold
			);
			runCommands(blackJack, "LR", "100", "hit", "hold", " ", " ", " ", "no");
			assertContains("Round 1: Player1's score is: 19");
			assertContains("Round 1: Player1 #2 HOLD");
		...
		public void T2_05_highest_bidder_black_jack_should_hold_on_17() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human blackjack
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack - not relevant
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack - not relevant
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS),
					new Card(Card.Rank.TWO, Card.Suit.CLUBS) // dealer should reach >=17
			);
			runCommands(blackJack, "LR", "100", "hit", "hold", " ", " ", " ", "no");
		...
		public void T2_06_dealer_should_change_strategy_should_hit_win() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human wins
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.SIX, Card.Suit.HEARTS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // BOT BUSTED
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.CLUBS), // dealer busted
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human wins
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.SIX, Card.Suit.HEARTS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // BOT BUSTED
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.SIX, Card.Suit.HEARTS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // BOT BUSTED
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.CLUBS), // dealer busted
					// third round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // 18
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS),
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.THREE, Card.Suit.HEARTS));
		...
		public void T2_07_dealer_should_change_strategy_should_hit_lost() {
			BlackJack blackJack = new BlackJack(
					...
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS),
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS) // dealer busted
			);
			runCommands(blackJack, "LR",
					// first round
					"100", " ", " ", " ", "yes",
		...
		public void T2_08_dealer_should_change_strategy_target_bot() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.KING, Card.Suit.HEARTS), new Card(Card.Rank.KING, Card.Suit.SPADES), // human busted
					new Card(Card.Rank.THREE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), new Card(Card.Rank.EIGHT, Card.Suit.SPADES), // BOT 21
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), // dealer HOLD even if it is loosing from BOT1
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human wins
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.FIVE, Card.Suit.HEARTS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // BOT BUSTED
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.CLUBS), // dealer busted
					// third round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // 18
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS),
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.TWO, Card.Suit.CLUBS) // dealer busted
			);
			runCommands(blackJack, "LR",
					// first round
					"100", "hit", " ", " ", " ", "yes",
		...
		public void T2_09_dealer_should_change_strategy_fifth_rounds() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // HOLD LOST
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.ACE, Card.Suit.CLUBS), // dealer BLACKJACK
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // 20 HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // 18 HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS), // dealer HIT HOLD (target
																							// human)
					// third round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20 WINS
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // 18 WINS
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19 WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.FIVE, Card.Suit.CLUBS), new Card(Card.Rank.KING, Card.Suit.CLUBS), // dealer busted
					// fourth round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), new Card(Card.Rank.SEVEN, Card.Suit.HEARTS), // BUSTED
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS), // dealer HOLD
					// fifth round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20 WINS
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.EIGHT, Card.Suit.HEARTS), // 18 WINS
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19 WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.SEVEN, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS) // dealer
																												// should
																												// target
																												// Bot2
			// hold with 19
		...
		public void T2_10_dealer_should_not_change_strategy() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // HOLD LOST
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.ACE, Card.Suit.CLUBS), // dealer BLACKJACK
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS), // 20 HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.NINE, Card.Suit.HEARTS), // 18 HOLD LOST
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS), // dealer HIT HOLD (target
																							// human)
					// third round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20 LOST
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.NINE, Card.Suit.HEARTS), // 18 LOST
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19 LOST
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK
					// fourth round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), new Card(Card.Rank.SEVEN, Card.Suit.HEARTS), // BUSTED
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.ACE, Card.Suit.SPADES), // BLACKJACK WINS
					...
					// fifth round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // 20 WINS
					new Card(Card.Rank.JACK, Card.Suit.CLUBS), new Card(Card.Rank.NINE, Card.Suit.HEARTS), // 18 WINS
					new Card(Card.Rank.JACK, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.SPADES), // 19 WINS
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.SEVEN, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS),
					new Card(Card.Rank.ACE, Card.Suit.HEARTS) // dealer
			// should
			// target
			// human
			// hold with 19
	...
	public static class Task3Test extends TaskTest {
		...
		public void T3_01_all_player_wins() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.KING, Card.Suit.HEARTS), // blackjack
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.NINE, Card.Suit.CLUBS) // dealer can't win because all players have blackjack
			);
		...
		public void T3_02_all_player_lost() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.KING, Card.Suit.HEARTS), // blackjack
					new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.TEN, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.ACE, Card.Suit.CLUBS) // dealer can't win because all players have blackjack
			);
		...
		public void T3_03_bot_wins() {
			BlackJack blackJack = new BlackJack(new Card(Card.Rank.TEN, Card.Suit.HEARTS), new Card(Card.Rank.KING, Card.Suit.HEARTS), // blackjack
					new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.JACK, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.TEN, Card.Suit.SPADES), new Card(Card.Rank.ACE, Card.Suit.CLUBS));
			runCommands(blackJack, "LR", "100", "hold", " ", " ", " ", "no");
		...
		public void T3_04_three_turn_correct() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human wins
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TEN, Card.Suit.CLUBS), // dealer cannot win
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.SEVEN, Card.Suit.HEARTS), // human lost
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.TEN, Card.Suit.CLUBS), // dealer wins human
		...
		public void T3_06_final_result_2() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.ACE, Card.Suit.HEARTS), // human lost
					new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.SPADES), new Card(Card.Rank.TEN, Card.Suit.CLUBS), // dealer cannot win
					// second round
					new Card(Card.Rank.KING, Card.Suit.CLUBS), new Card(Card.Rank.KING, Card.Suit.HEARTS), new Card(Card.Rank.NINE, Card.Suit.CLUBS), // human lost
					new Card(Card.Rank.ACE, Card.Suit.CLUBS), new Card(Card.Rank.QUEEN, Card.Suit.HEARTS), // BOT blackjack
					new Card(Card.Rank.ACE, Card.Suit.HEARTS), new Card(Card.Rank.JACK, Card.Suit.SPADES), // BOT blackjack
					new Card(Card.Rank.KING, Card.Suit.SPADES), new Card(Card.Rank.SIX, Card.Suit.CLUBS), // dealer wins human
